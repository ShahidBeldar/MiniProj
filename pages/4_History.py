...
st.set_page_config(page_title="History · Finance Impact", layout="wide", initial_sidebar_state="expanded")
...
with f5:
    st.markdown("<br>", unsafe_allow_html=True)
    if st.button("Clear All", type="secondary", use_container_width=True, key="_hist_clr"):
        clear_history(_uid)
        st.rerun()
