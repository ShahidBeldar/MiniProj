"""
ui/theme.py — Global CSS (new fonts: Syne + Manrope + JetBrains Mono) + SVG icons.
"""
...
.stButton > button:hover {
  ...
  box-shadow: 0 4px 24px rgba(0,200,240,.30) !important;
}
...
[data-testid="stSidebar"] .stButton > button[kind="primary"] {
  ...
  border: 1px solid rgba(0,200,240,.20) !important;
  box-shadow: none !important;
  transform: none !important;
}
...
.fi-card::before {
  ...
  height: 1px;
  background: linear-gradient(90deg, transparent, rgba(0,200,240,.18), transparent);
}
.fi-card-accent {
  border-color: rgba(0,200,240,.22) !important;
  box-shadow: 0 0 24px rgba(0,200,240,.06);
}
.fi-title {
...
/* ── HISTORY ITEMS ── */
.hist-item {
  display: flex; gap: 9px; padding: .85rem;
  border-radius: 10px;
  border: 1px solid var(--b1);
  background: var(--bg3);
  margin-bottom: 5px;
...
.pol-track {
  ...
  background: linear-gradient(90deg,
    #AA1133 0%, #FF3D60 20%, #FF7D35 33%,
    #2D4060 50%,
    #00A86B 67%, #00E8A0 80%, #00FF88 100%);
  position: relative;
}
.pol-thumb {
  position: absolute;
