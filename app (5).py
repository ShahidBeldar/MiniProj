...
from ui.components import page_header, stat_box, stat_row
...
for col, (title, body, pg, lbl, accent) in zip(grid, _cards):
    with col:
        st.markdown(f"""
            <div class="fi-card" style="border-top:2px solid {accent}22;min-height:118px;">
                <div style="font-family:'Syne',sans-serif;font-weight:700;font-size:.92rem;
                    ...
                    <span style="width:7px;height:7px;border-radius:50%;
                                 ...
                                 box-shadow:0 0 6px {accent};display:inline-block;"></span>
                    {title}
                </div>
